...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'template' => '{permit} {switch} {resend_password} {update} {delete}',
            'buttons' => [
                ...
                'permit' => function ($url, $model) {
                    return Html::a('<span class="glyphicon glyphicon-warning-sign"></span>', Url::to(['/permit/user/view', 'id' => $model->id]), [
